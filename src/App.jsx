      ...
      <div id="second-page">
        <div id="second-overlay">
            <div id="map-container">
              ...
              <LoadScript
                googleMapsApiKey="AIzaSyDhqNr7DhwoD9GFYegmDZEt9_584QVImGE"
                libraries={['places']}
              >
                <GoogleMap
        ...
        <div id="carouselExampleCaptions" className="carousel slide">
          ...
          <div className="carousel-inner">
            <div className="carousel-item active">
              <img src="/public/clothes.png" className="d-block w-100" alt="Clothes" />
            ...
            <div className="carousel-item">
              <img src="/public/shoes.png" className="d-block w-100" alt="Shoes" />
              <div className="carousel-caption d-none d-md-block">
                <h5>Shoes</h5>
            ...
            <div className="carousel-item">
              <img src="/public/many more.png" className="d-block w-100" alt="Many more" />
              <div className="carousel-caption d-none d-md-block">
                <h5>And many more!</h5>
